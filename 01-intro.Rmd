...
```{r}
# 2) Boxplot por pais (mas legible, mantiene la misma paleta)
...
# 3) Violín + boxplot (mas grande y legible, mantiene paleta)
...
# 4) (Extra) Boxplot por quinquenio: tasa_fin_cap vs categoria temporal
df_q <- df_2 %>%
...
```{r}
# ===== 6.2 Variable numerica vs numerica =====
library(dplyr)
library(ggplot2)
